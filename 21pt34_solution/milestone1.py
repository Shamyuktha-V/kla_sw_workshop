...
file=open("Workshop2024\\Milestone1\\Input\\Testcase4.txt","r")
details_wafer=dict()
...
slope_1=np.tan(details_wafer["Angle"]*(np.pi/180))
...
with open('21pt34_solution\\milestone1testcase4.txt','w',newline='') as file1:
